...
var Mtl = function(source, target, options) {
	...
	var ops = Mtl.identifyDestinations(videos, targets);

	console.info(ops);
	
}
Mtl.identifyVideos = function(files) {
	var output = {};
	for (var i in files) {
		var f = files[i];
...
Mtl.identifyDestinations = function(videos, target) {
	var ops = {};
